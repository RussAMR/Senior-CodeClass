...
namespace IntroRecap
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            stringArray[0] = "Andrew, Russell";
            stringArray[1] = "Russell";
            stringArray[2] = "Colorado springs";
            stringArray[3] = "colorado";
            stringArray[4] = "United States of America";
